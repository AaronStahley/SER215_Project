...
public class resolution {
    ...
    public void getRes0() {
        Client.frame.setSize(1920, 1080);
        Client.frame.setLocationRelativeTo(null);

    }

    public void getRes1() {
        Client.frame.setSize(1768, 992);
        Client.frame.setLocationRelativeTo(null);

    }

    public void getRes2() {
        Client.frame.setSize(1680, 1050);
        Client.frame.setLocationRelativeTo(null);

    }

    public void getRes3() {
        Client.frame.setSize(1600, 1024);
        Client.frame.setLocationRelativeTo(null);
    ...
    public void getRes5() {
        Client.frame.setSize(1366, 768);
        Client.frame.setLocationRelativeTo(null);

    }

    public void getRes6() {
        Client.frame.setSize(1360, 768);
        Client.frame.setLocationRelativeTo(null);

    }

    public void getRes7() {
        Client.frame.setSize(1280, 1024);
        Client.frame.setLocationRelativeTo(null);

    }

    public void getRes8() {
        Client.frame.setSize(1280, 960);
        Client.frame.setLocationRelativeTo(null);

    }

    public void getRes9() {
        Client.frame.setSize(1280, 800);
        Client.frame.setLocationRelativeTo(null);

    }

    public void getRes10() {
        Client.frame.setSize(1280, 768);
        Client.frame.setLocationRelativeTo(null);

    }

    public void getRes11() {
        Client.frame.setSize(1280, 720);
        Client.frame.setLocationRelativeTo(null);

    }

    public void getRes12() {
        Client.frame.setSize(1176, 664);
        Client.frame.setLocationRelativeTo(null);

    }

    public void getRes13() {
        Client.frame.setSize(1152, 864);
        Client.frame.setLocationRelativeTo(null);

    }

    public void getRes14() {
        Client.frame.setSize(1024, 768);
        Client.frame.setLocationRelativeTo(null);
